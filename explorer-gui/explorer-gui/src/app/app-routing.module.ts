...
import { CidQueryComponent } from "./pages/cidquery/cidquery.component";
...
const singleNetwork = environment.jsonApiDiscoveryRootUrl == null;

const routes: Routes = [
  {
    path: singleNetwork ? "network-overview" : "",
  ...
  // Redirect old URLs
  {
    path: ":type/:network/system/block/:id",
    redirectTo: ":type/:network/block/:id",
  },
  { path: ":type/:network/system/block", redirectTo: "/:type/:network/block" },
  {
    path: ":type/:network/system/extrinsic/:id",
    redirectTo: "/:type/:network/extrinsic/:id",
  },
  {
    path: ":type/:network/system/extrinsic",
    redirectTo: "/:type/:network/extrinsic",
  },
  {
    path: ":type/:network/system/event/:id",
    redirectTo: "/:type/:network/event/:id",
  },
  { path: ":type/:network/system/event", redirectTo: "/:type/:network/event" },
  {
    path: ":type/:network/system/runtime/:id",
    redirectTo: "/:type/:network/runtime/:id",
  },
  {
    path: ":type/:network/system/runtime",
    redirectTo: "/:type/:network/runtime",
  },
  {
    path: ":type/:network/system/runtime-module/:id",
    redirectTo: "/:type/:network/runtime-module/:id",
  },
  {
    path: ":type/:network/system/runtime-call/:id",
    redirectTo: "/:type/:network/runtime-call/:id",
  },
  {
    path: ":type/:network/system/runtime-event/:id",
    redirectTo: "/:type/:network/runtime-event/:id",
  },
  {
    path: ":type/:network/system/runtime-storage/:id",
    redirectTo: "/:type/:network/runtime-storage/:id",
  },
  {
    path: ":type/:network/system/account/:id",
    redirectTo: "/:type/:network/account/:id",
  },
  {
    path: ":type/:network/module/account/:id",
    redirectTo: "/:type/:network/account/:id",
  },
  {
    path: ":type/:network/system/account",
    redirectTo: "/:type/:network/account",
  },
  {
    path: "pre/kusama-cc3/transaction/:hash",
    redirectTo: "/pre/kusama/transaction/:hash",
  },
  { path: "pre/kusama-cc3/account/:id", redirectTo: "/pre/kusama/account/:id" },
  { path: "pre/kusama-cc3", redirectTo: "/pre/kusama" },
  {
    path: "polkadot-cc1/transaction/:hash",
    redirectTo: "/polkadot/transaction/:hash",
  },
  { path: "polkadot-cc1/account/:id", redirectTo: "/polkadot/account/:id" },
  { path: "polkadot-cc1", redirectTo: "/polkadot" },

  {
    path: singleNetwork ? "" : ":network",
    ...
    children: [
      ...
      { path: "cidquery", component: CidQueryComponent },
      {
        path: "extrinsic-param/download/:extrinsicId/:hash",
        component: ExtrinsicParamDownloadComponent,
      },
      ...
      {
        path: "runtime-constant/:id",
        component: RuntimeConstantDetailComponent,
      },
      { path: "runtime-type", component: RuntimeTypeListComponent },
      { path: "account", component: AccountListComponent },
      {
        path: "account/validators",
        component: AccountListComponent,
        data: { filter: "is_validator", title: "Validators" },
      },
      {
        path: "account/nominators",
        component: AccountListComponent,
        data: { filter: "is_nominator", title: "Nominators" },
      },
      {
        path: "account/council",
        component: AccountListComponent,
        data: { filter: "is_council_member", title: "Council members" },
      },
      {
        path: "account/tech-comm",
        component: AccountListComponent,
        data: {
          filter: "is_tech_comm_member",
          title: "Technical committee members",
        },
      },
      {
        path: "account/registrars",
        component: AccountListComponent,
        data: { filter: "is_registrar", title: "Registrars" },
      },
      {
        path: "account/treasury",
        component: AccountListComponent,
        data: { filter: "is_treasury", title: "Treasury accounts" },
      },
      {
        path: "account/sudo",
        component: AccountListComponent,
        data: { filter: "is_sudo", title: "Sudo accounts" },
      },
      {
        path: "account/identities",
        component: AccountListComponent,
        data: { filter: "has_identity", title: "Accounts with identity" },
      },
