...
import { ContractInstanceService } from './contract-instance.service';
...
export class AppConfigService {
  ...
  public setNetwork(network: Network, singleNetwork: boolean = false) {
      ...
      this.contractInstanceService.jsonApiRootUrl = network.attributes.api_url_root;
      ...
      this.networkURLPrefix = singleNetwork ? '/' : ('/' + network.attributes.network_id);
