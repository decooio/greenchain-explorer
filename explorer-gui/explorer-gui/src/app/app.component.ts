...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    const oldLang = window.localStorage.getItem('lang')
    this.selectedLanguage = oldLang? oldLang: translate.getBrowserLang().match(/en|zh|ko|de|ru|uk|hi|pt|fr|ja|tr|th|es/) ? translate.getBrowserLang() : 'en';
