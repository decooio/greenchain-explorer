...
app.add_route('/contract/instance', polkascan.ContractInstanceListResource())
app.add_route('/contract/instance/{item_id}', polkascan.ContractInstanceDetailResource())
